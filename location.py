...
def readlist_towerbridge():
	d = [ ["Hays Galleria" ,"51.505524,-0.083599", 0,"&bull; Open air shopping and cafes</br> &bull; Old fashioned atmospheric market stalls everything from London souvenirs to with good quality jewellery and leather goods</br> &bull; Fountain in the centre - 60 foot sculpture by artist David Kemp was installed in 1987</br> &bull; View of the Thames, sky garden, and other skyscrapers including the Gherkin</br> &bull; Access to the riverbank of the Thames", "towerbridge"], ["Science Gallery" , "51.502831,-0.088251",0,"&bull; Gallery of Exhibitions, events performances and festivals that combine technology, science, art and sound</br> &bull; Collaboration between Kings College London University of London and Science Gallery International to create a unique exhibition","science"], ["Glassblowing" , "51.5016,0.0823",0,"&bull; One of the top glassblowing houses in Europe<br/> &bull; Exhibitions from resident artists<br/> &bull; Glass blowing demonstrations <br/> &bull; Possible to take classes taught by professionals (but very expensive and must be booked well in advance)<br/>","glassblowing"]]
	x = 0
	startcoord = ""
	if 'location' in request.cookies:
		startcoord = flask.request.cookies.get('location')
...
def readlist_hydepark():
	d = [ ["Aplsey House" ,"51.505524,-0.083599", 0,"&bull; National Trust Georgian mansion<br/> &bull; Decor has hardly changed since it was owned by the conquerer of Napoleon, the Duke of Wellington, in the Battle of Waterloo 1815<br/> &bull; History and architecture go back even further than the Duke of Wellington<br/> &bull; Gifts from Emperors and Royalty on display<br/> &bull; Art collection<br/> &bull; Multimedia guided tour<br/>", "alpsey"], ["Serpentine Gallery" , "51.502831,-0.088251",0,"&bull; Small art gallery<br/> &bull; Exhibits on either side of Lake Serpentine which runs through Hyde Park Kensington<br/> &bull; Constant changeover of popup exhibitions by different artists working with different mediums and styles<br/>","serpentine"], ["Summer of Sound On The Roof" , "51.5016,0.0823",0,"&bull; Oxford Circus John Lewis Rooftop attraction<br/> &bull; Venue for music - daytime gigs and DJ sets, street food pop ups and crazy golf throughout the summer<br/> &bull; Pop up stalls<br/> &bull; Musicians vary each day so check the schedule on the John Lewis website to see who is playing when<br/>","johnlewis"]]
	x = 0
	startcoord = ""
	if 'location' in request.cookies:
		startcoord = flask.request.cookies.get('location')
...
def readlist_canarywharf():
	d = [ ["Giant Robot" ,"51.505524,-0.083599", 0,"&bull; A seven-day-a-week food arena right on the rooftop of the Crossrail brought to you by Shoreditch very own Dinerama</br> &bull;Whether you're in the need for afterwork drinks or a crazy street feast this place has it all</br> &bull; Retro furniture and tunes to make you feel you're back at a nightclub, the vibe is alway on point</br>", "giantrobot"], ["Crossrail Rooftop Garden" , "51.502831,-0.088251",0,"&bull; A hidden gem surrounded by skyscrappers, as the newly built Crossrail beholds this enchanted rooftop garden at the heart of Canary Wharf</br> &bull; A 300 metres enclosed garden with an abundance of exotic plants and trees, perfect for you to escape that city life right at the very heart of canary wharf</br> &bull; Get the chance to see a variety of live music and performances whilst there</br>","crossrail"], ["The Grapes" , "51.5016,0.0823",0,"&bull; Dating all the way back to 1583, what may appear as your average pub hides the biggest secret to it all, as this Victorian pub is owned by the one and only Sir Ian McKellan</br> &bull; The Grapes is even more unique as it appears, scarcely disguised, in the opening chapter of Charles Dicken's novel - Our Mutual Friend, who knew Limehouse well for over 40 years</br> &bull;Above it all, the Grapes provide the perfect view as you step on to their back porch and gaze along the Thames and the London skyline</br>","grapes"]]
	x = 0
	startcoord = ""
	if 'location' in request.cookies:
		startcoord = flask.request.cookies.get('location')
...
def readlist_leicestersquare():
	d = [ ["Second Hand Book Shopping" ,"51.505524,-0.083599", 0,"&bull; Charing Cross Road has 3 Second hand bookshops on one parade Any Amount of Books Henry Pordes and Quintos Bookshop based in the basement of Francis Edwards Antique and Rare books.<br/> &bull; Most books 4 and under<br/> &bull; Any Amount of Books periodically has basement sales where any book Is 1 or 5 books for 4 check their social media for basement sale announcements if interested<br/> &bull; Quintoss restocks completely each month<br/>", "secondhand"], ["Live Music Every Day in Covent Garden" , "51.502831,-0.088251",0,"&bull; Either opera or musicians live every day in the shopping complex between the streets and the Jubilee market one level below street level<br/> &bull; Not particularly crowded <br/> &bull; Good acoustics<br/>","coventgarden"], ["House of MinaLima" , "51.5016,0.0823",0,"&bull; 4 floors of exhibitions of the work by the graphic designers of the Warner Brothers Harry Potter and Fantastic Beasts franchises and 1 floor gift shop<br/> &bull; See props designs artwork and photos from both Fantastic Beasts and Where to find them and the Harry Potter Franchises<br/> &bull; Gift Shop with signed merchandise and prop replicas as well as limited edition prints<br/> &bull; Miraphora MIna and Eduardo Lima the graphic designers often pop in and surprise visitors<br/>","towerbridge"], ["Golden Square" , "51.502831,-0.088251",0,"&bull; Square gardens with lawns and shrubs<br/> &bull; Statue of George II on a plinth one of the only two public statues of George II in the capital<br/> &bull; Thought to have been laid out according to plans by Sir Christopher Wren around the year 1670s<br/>","goldensquare"]]
	x = 0
	startcoord = ""
	if 'location' in request.cookies:
		startcoord = flask.request.cookies.get('location')
...
def readlist_rooftops():
	d = [ ["Netil 360" ,"51.505524,-0.083599", 0,"&bull; Cosy, laid back rooftop just a stone throw away from Broadway Market</br> &bull; Unlike other rooftops, Netil 360 provides a workspace with great views during the day, turning into a nightclub at dark, as it hosts live DJ sets</br> &bull; Experience a panoramic view of London</br>", "netil360"], ["Coq d'Argent" , "51.502831,-0.088251",0,"&bull; Great place for afterwork drinks with a view of the Bank of England and city skyscrappers</br> &bull; A French brasserie with a heated rooftop garden serving food and cocktails whether its day or night</br>","coq"], ["Sushi Samba" , "51.5016,0.0823",0,"&bull; Experience views from the 38th floor of Heron Tower</br> &bull; Sushi samba not only provides great views but satisfies everyones craving, whether youre in the mood for Peruvian, Brazilian or even Japanese</br> &bull; Its fusion cuisine like youve never had before!</br>","sushi"]]
	x = 0
	startcoord = ""
	if 'location' in request.cookies:
		startcoord = flask.request.cookies.get('location')
